    ...
    <div class="wrapper">
        ...
        <div id="rev-slider-1" class="rev_slider gradient-slider" style="display:none" data-version="5.4.5">
          <ul>
            ...
            <li data-transition="crossfade">
              <!-- MAIN IMAGE -->
              <img src="images/slider/slider3.jpg" alt="Image" title="Image" data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" data-bgparallax="10" class="rev-slidebg" data-no-retina="">
              <!-- LAYER NR. 1 -->
              <h1
              ...
              <div
                ...
                style="z-index: 6; color: #fff;">Live Your Myth In Hotel Hamlyn</div>
              ...
              <div
                ...
                data-frames='[{"delay":1800,"speed":1500,"frame":"0","from":"y:[100%];z:0;rX:0deg;rY:0;rZ:0;sX:1;sY:1;skX:0;skY:0;opacity:0;","mask":"x:0px;y:[100%];s:inherit;e:inherit;","to":"o:1;","ease":"Power2.easeInOut"},{"delay":"wait","speed":500,"frame":"999","to":"auto:auto;","ease":"Power3.easeInOut"}]'
                style="color: #fff">
                Star Luxury Bungalow
              </div>
            </li>
            <!-- SLIDE NR. 2 -->
            <li data-transition="crossfade">
              <!-- MAIN IMAGE -->
              <img src="images/slider/slider2.jpg" alt="Image" title="Image" data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" data-bgparallax="10" class="rev-slidebg" data-no-retina="">
              <!-- LAYER NR. 1 -->
              <div
                class="tp-caption tp-resizeme"
                data-x="center"
            ...
            <li data-transition="crossfade">
              <!-- MAIN IMAGE -->
              <img src="images/slider/slider1.jpg" alt="Image" title="Image" data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" data-bgparallax="10" class="rev-slidebg" data-no-retina="">
              <!-- LAYER NR. 1 -->
              <div
                class="tp-caption tp-resizeme"
                data-x="center"
          ...
          <div class="row">
            <div class="col-lg-8">
              ...
              <div class="info-branding">
                ...
                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Ad dolorem iste suscipit voluptates architecto nemo. Lorem ipsum dolor sit amet, consectetur adipisicing elit. Ad dolorem iste suscipit voluptates architecto nemo. Lorem ipsum dolor sit amet, consectetur adipisicing elit. Ad dolorem iste suscipit voluptates architecto nemo.</p>
              </div>
            </div>
            <div class="col-lg-4">
              <div class="brand-info">
                <div class="inner">
                  <div class="content">
                    ...
                    <h5 class="title">LUXURY BUNGALOW</h5>
            ...
            <div class="col-md-4">
              <div class="room-grid-item">
                <figure class="gradient-overlay-hover link-icon">
                  ...
                  <div class="room-price">Rs.5,000 / night</div>
                </figure>
                <div class="room-info">
                  <h2 class="room-title">
            ...
            <div class="col-md-4">
              <div class="room-grid-item">
                <figure class="gradient-overlay-hover link-icon">
                  ...
                  <div class="room-price">Rs.6,000 / night</div>
                </figure>
                <div class="room-info">
                  <h2 class="room-title">
            ...
            <div class="col-md-4">
              <div class="room-grid-item">
                <figure class="gradient-overlay-hover link-icon">
                  ...
                  <div class="room-price">Rs.8,500 / night</div>
                </figure>
                <div class="room-info">
                  <h2 class="room-title">
          ...
          <div class="row">
            <div class="col-lg-7 col-12">
              <div data-slider-id="services" class="services-owl owl-carousel">
                ...
                <figure class="gradient-overlay">
                  <img src="images/services/cycling.jpg" class="img-fluid" alt="Image">
                  <figcaption>
                    <h4>Cycling</h4>
                  </figcaption>
                </figure>
                <figure class="gradient-overlay">
                  <img src="images/services/tours.jpg" class="img-fluid" alt="Image">
                  <figcaption>
                    <h4>Day Tours</h4>
                  </figcaption>
                </figure>
                <figure class="gradient-overlay">
                  <img src="images/services/games.jpg" class="img-fluid" alt="Image">
                  <figcaption>
                    <h4>Board Games</h4>
                  </figcaption>
                </figure>
     ...
     <!-- ========== NEWS ==========-->
      <section class="news">
        <div class="container">
          <div class="section-title">
            <h4 class="title">ATTRACTIONS</h4>
            <p class="section-subtitle">Check out our area attractions</p>
          </div>
          <div class="row">
            <!-- ITEM -->
            <div class="col-md-4">
